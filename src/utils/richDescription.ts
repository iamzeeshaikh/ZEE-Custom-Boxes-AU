...
function detectType(name: string, categories: string[]): ProductType {
  ...
  if (n.includes('sticker') || (n.includes(' label') && !n.includes('lip balm') && !n.includes('candle label') && !n.includes('honey label')) || c.includes('sticker') || c.includes('label')) return 'sticker';
